...
'app.aliases.Vite','app.version','app.rate_limiter.enabled','auth.defaults.guard','auth.guards.web.driver',
'auth.guards.web.provider','auth.guards.api_token.driver','auth.guards.api_token.provider','auth.guards.api_headers.driver','auth.guards.api_headers.provider',
'auth.guards.dummy.driver','auth.guards.dummy.provider','auth.providers.users.driver','auth.providers.users.model','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.dummy_user_id',
...
'database.redis.default.url','database.redis.default.host','database.redis.default.port','database.redis.default.username','database.redis.default.password',
'database.redis.default.sentinel_host','database.redis.default.sentinel_port','database.redis.default.sentinel_service','database.redis.default.sentinel_timeout','database.redis.default.sentinel_persistent',
'database.redis.default.sentinel_retry_interval','database.redis.default.sentinel_read_timeout','database.redis.default.sentinel_username','database.redis.default.sentinel_password','database.redis.default.database',
'database.redis.cache.url','database.redis.cache.host','database.redis.cache.port','database.redis.cache.username','database.redis.cache.password',
'database.redis.cache.sentinel_host','database.redis.cache.sentinel_port','database.redis.cache.sentinel_service','database.redis.cache.sentinel_timeout','database.redis.cache.sentinel_persistent',
'database.redis.cache.sentinel_retry_interval','database.redis.cache.sentinel_read_timeout','database.redis.cache.sentinel_username','database.redis.cache.sentinel_password','database.redis.cache.database',
'database.redis.horizon.url','database.redis.horizon.host','database.redis.horizon.port','database.redis.horizon.username','database.redis.horizon.password',
'database.redis.horizon.sentinel_host','database.redis.horizon.sentinel_port','database.redis.horizon.sentinel_service','database.redis.horizon.sentinel_timeout','database.redis.horizon.sentinel_persistent',
'database.redis.horizon.sentinel_retry_interval','database.redis.horizon.sentinel_read_timeout','database.redis.horizon.sentinel_username','database.redis.horizon.sentinel_password','database.redis.horizon.database',
'database.redis.horizon.options.prefix','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./mnt/data_2/INFINITE/infinity/backend/public/static/public','hashing.driver',
'hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory','hashing.argon.threads','hashing.argon.time',
'hashing.argon.verify','hashing.rehash_on_login','horizon.domain','horizon.path','horizon.use',
...
'oidc.client_secret','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'scribe.auth.extra_info','scribe.intro_text','scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides.info.version',
...
'services.authentik.cg_admin_group_id','services.authentik.xcg_admin_group_id','view.paths','view.compiled','concurrency.default',
...
'session.partitioned','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'data.livewire.enable_synths','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddQueries.maximum_number_of_collected_queries',
...
'ARGON_THREADS','ARGON_TIME','AUTH_DUMMY_USER_ID','RATE_LIMITER_ENABLED','OIDC_CONFIGURATIONS_URI',
'OIDC_CLIENT_ID','OIDC_CLIENT_SECRET','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','BROADCAST_CONNECTION','QUEUE_CONNECTION','FILESYSTEM_DISK',
'CACHE_STORE','CACHE_PREFIX','REDIS_CLIENT','REDIS_HOST','REDIS_PORT',
'REDIS_PASSWORD','AUTHENTIK_BASE_URL','AUTHENTIK_TOKEN','AUTHENTIK_CORE_TEAM_GROUP_ID','AUTHENTIK_XCORE_TEAM_GROUP_ID',
'AUTHENTIK_CG_ADMIN_GROUP_ID','AUTHENTIK_XCG_ADMIN_GROUP_ID','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
