...
'blobs.show','api.v1.achievements.index','api.v1.achievements.show','api.v1.configs.index','api.v1.configs.show',
'api.v1.competitions.index','api.v1.competitions.show','api.v1.community-groups.index','api.v1.community-groups.show','api.v1.community-group-admins.index',
...
'api.v1.users.show','api.v1.community-groups.members.index','api.v1.community-group-admins.members.index','api.v1.core-teams.members.index','api.v1.users.permissions.index',
'api.v1.users.personas.index','api.v1.community-group-members.show','api.v1.community-group-admin-members.show','api.v1.core-team-members.show','api.v1.user-permissions.show',
'api.v1.user-personas.show','api.v1.tokens.index','api.v1.tokens.show','api.v1.tokens.destroy','api.v1.achievements.store',
'api.v1.achievements.update','api.v1.achievements.destroy','api.v1.configs.store','api.v1.configs.update','api.v1.configs.destroy',
'api.v1.competitions.store','api.v1.competitions.update','api.v1.competitions.destroy','api.v1.community-groups.store','api.v1.community-groups.update',
'api.v1.community-groups.destroy','api.v1.community-group-admins.store','api.v1.community-group-admins.update','api.v1.community-group-admins.destroy','api.v1.core-teams.store',
'api.v1.core-teams.update','api.v1.core-teams.destroy','api.v1.personas.store','api.v1.personas.update','api.v1.personas.destroy',
'api.v1.project-galleries.store','api.v1.project-galleries.update','api.v1.project-galleries.destroy','api.v1.testimonials.store','api.v1.testimonials.update',
'api.v1.testimonials.destroy','api.v1.users.store','api.v1.users.update','api.v1.users.destroy','api.v1.competition-organizer-types.index',
'api.v1.competition-organizer-types.store','api.v1.competition-organizer-types.show','api.v1.competition-organizer-types.update','api.v1.competition-organizer-types.destroy','api.v1.competition-outputs.index',
'api.v1.competition-outputs.store','api.v1.competition-outputs.show','api.v1.competition-outputs.update','api.v1.competition-outputs.destroy','api.v1.competition-ranks.index',
'api.v1.competition-ranks.store','api.v1.competition-ranks.show','api.v1.competition-ranks.update','api.v1.competition-ranks.destroy','api.v1.competition-scales.index',
'api.v1.competition-scales.store','api.v1.competition-scales.show','api.v1.competition-scales.update','api.v1.competition-scales.destroy','api.v1.competition-team-types.index',
'api.v1.competition-team-types.store','api.v1.competition-team-types.show','api.v1.competition-team-types.update','api.v1.competition-team-types.destroy','api.v1.competition-time-ranges.index',
'api.v1.competition-time-ranges.store','api.v1.competition-time-ranges.show','api.v1.competition-time-ranges.update','api.v1.competition-time-ranges.destroy','api.v1.core-team-divisions.index',
'api.v1.core-team-divisions.store','api.v1.core-team-divisions.show','api.v1.core-team-divisions.update','api.v1.core-team-divisions.destroy','api.v1.degrees.index',
'api.v1.degrees.store','api.v1.degrees.show','api.v1.degrees.update','api.v1.degrees.destroy','api.v1.faculties.index',
'api.v1.faculties.store','api.v1.faculties.show','api.v1.faculties.update','api.v1.faculties.destroy','api.v1.fund-applications.index',
'api.v1.fund-applications.store','api.v1.fund-applications.show','api.v1.fund-applications.update','api.v1.fund-applications.destroy','api.v1.groups.index',
'api.v1.groups.store','api.v1.groups.show','api.v1.groups.update','api.v1.groups.destroy','api.v1.majors.index',
'api.v1.majors.store','api.v1.majors.show','api.v1.majors.update','api.v1.majors.destroy','api.v1.permissions.index',
'api.v1.permissions.store','api.v1.permissions.show','api.v1.permissions.update','api.v1.permissions.destroy','api.v1.teams.index',
'api.v1.teams.store','api.v1.teams.show','api.v1.teams.update','api.v1.teams.destroy','api.v1.community-groups.members.store',
'api.v1.community-group-admins.members.store','api.v1.core-teams.members.store','api.v1.users.permissions.store','api.v1.users.personas.store','api.v1.groups.permissions.index',
'api.v1.groups.permissions.store','api.v1.teams.members.index','api.v1.teams.members.store','api.v1.users.groups.index','api.v1.users.groups.store',
'api.v1.community-group-members.update','api.v1.community-group-members.destroy','api.v1.community-group-admin-members.update','api.v1.community-group-admin-members.destroy','api.v1.core-team-members.update',
'api.v1.core-team-members.destroy','api.v1.user-permissions.update','api.v1.user-permissions.destroy','api.v1.user-personas.update','api.v1.user-personas.destroy',
'api.v1.group-permissions.show','api.v1.group-permissions.update','api.v1.group-permissions.destroy','api.v1.team-members.show','api.v1.team-members.update',
'api.v1.team-members.destroy','api.v1.user-groups.show','api.v1.user-groups.update','api.v1.user-groups.destroy','scribe.',
