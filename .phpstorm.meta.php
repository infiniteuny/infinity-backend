...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./mnt/data_2/INFINITE/infinity/backend/public/static/public' => 'string',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.version','app.rate_limiter.enabled',
'auth.defaults.guard','auth.defaults.semi_public_guard','auth.guards.web.driver','auth.guards.web.provider','auth.guards.api_token.driver',
'auth.guards.api_token.provider','auth.guards.api_headers.driver','auth.guards.api_headers.provider','auth.guards.dummy.driver','auth.guards.dummy.provider',
...
'auth.passwords.users.throttle','auth.password_timeout','auth.dummy_user_id','broadcasting.default','broadcasting.connections.reverb.driver',
...
'filesystems.disks.s3.report','filesystems.links./mnt/data_2/INFINITE/infinity/backend/public/static/public','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'octane.cache.bytes','octane.watch','octane.garbage','octane.max_execution_time','octane.swoole.options.http_compression',
'octane.swoole.options.http_compression_level','octane.swoole.options.compression_min_length','octane.swoole.options.package_max_length','octane.swoole.options.open_http2_protocol','octane.swoole.options.document_root',
'octane.swoole.options.enable_static_handler','oidc.configurations_uri','oidc.client_id','oidc.client_secret','permission.models.permission',
...
'permission.cache.key','permission.cache.store','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort',
