...
'database.redis.default.port','database.redis.default.username','database.redis.default.password','database.redis.default.sentinel_host','database.redis.default.sentinel_port',
'database.redis.default.sentinel_service','database.redis.default.sentinel_timeout','database.redis.default.sentinel_persistent','database.redis.default.sentinel_retry_interval','database.redis.default.sentinel_read_timeout',
'database.redis.default.sentinel_username','database.redis.default.sentinel_password','database.redis.default.database','database.redis.cache.url','database.redis.cache.host',
'database.redis.cache.port','database.redis.cache.username','database.redis.cache.password','database.redis.cache.sentinel_host','database.redis.cache.sentinel_port',
'database.redis.cache.sentinel_service','database.redis.cache.sentinel_timeout','database.redis.cache.sentinel_persistent','database.redis.cache.sentinel_retry_interval','database.redis.cache.sentinel_read_timeout',
'database.redis.cache.sentinel_username','database.redis.cache.sentinel_password','database.redis.cache.database','database.redis.horizon.url','database.redis.horizon.host',
'database.redis.horizon.port','database.redis.horizon.username','database.redis.horizon.password','database.redis.horizon.sentinel_host','database.redis.horizon.sentinel_port',
'database.redis.horizon.sentinel_service','database.redis.horizon.sentinel_timeout','database.redis.horizon.sentinel_persistent','database.redis.horizon.sentinel_retry_interval','database.redis.horizon.sentinel_read_timeout',
'database.redis.horizon.sentinel_username','database.redis.horizon.sentinel_password','database.redis.horizon.database','database.redis.horizon.options.prefix','filesystems.default',
'filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.url','filesystems.disks.local.throw','filesystems.disks.local.report',
...
'filesystems.disks.s3.report','filesystems.links.E:\\INFINITE\\infinity\\backend\\public\\static/public','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'mail.markdown.extensions','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'oidc.configurations_uri','oidc.client_id','oidc.client_secret','permission.models.permission','permission.models.role',
...
'query-builder.parameters.append','query-builder.delimiter','query-builder.suffixes.count','query-builder.suffixes.exists','query-builder.suffixes.min',
...
'query-builder.disable_invalid_include_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','query-builder.count_suffix',
'query-builder.exists_suffix','query-builder.disable_invalid_includes_query_exception','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','scribe.title','scribe.description',
'scribe.intro_text','scribe.base_url','scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.include',
...
'scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides.info.version','scribe.openapi.enabled','scribe.openapi.overrides.info.version',
...
'scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responses.5.1.only','scribe.strategies.responses.5.1.except','scribe.strategies.responses.5.1.config.app.debug',
'scribe.strategies.responses.5.1.queryParams','scribe.strategies.responses.5.1.bodyParams','scribe.strategies.responses.5.1.fileParams','scribe.strategies.responses.5.1.cookies','scribe.strategies.responseFields',
'scribe.database_connections_to_transact','scribe.fractal.serializer','services.postmark.token','services.resend.key','services.ses.key',
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.authentik.base_url',
'services.authentik.token','services.authentik.core_team_group_id','services.authentik.xcore_team_group_id','services.authentik.cg_admin_group_id','services.authentik.xcg_admin_group_id',
...
'REDIS_HOST','REDIS_PORT','REDIS_PASSWORD','AUTHENTIK_BASE_URL','AUTHENTIK_TOKEN',
'AUTHENTIK_CORE_TEAM_GROUP_ID','AUTHENTIK_XCORE_TEAM_GROUP_ID','AUTHENTIK_CG_ADMIN_GROUP_ID','AUTHENTIK_XCG_ADMIN_GROUP_ID','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_APP_NAME','OCTANE_SERVER',);
