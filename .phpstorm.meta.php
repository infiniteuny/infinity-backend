...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./mnt/data_2/INFINITE/infinity/backend/public/static/public','hashing.driver','hashing.bcrypt.rounds',
...
'octane.swoole.options.http_compression','octane.swoole.options.http_compression_level','octane.swoole.options.compression_min_length','octane.swoole.options.package_max_length','octane.swoole.options.open_http2_protocol',
'octane.swoole.options.document_root','octane.swoole.options.enable_static_handler','oidc.configurations_uri','oidc.client_id','oidc.client_secret',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','scribe.title',
...
'scribe.intro_text','scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides.info.version','scribe.openapi.enabled',
'scribe.openapi.overrides.info.version','scribe.openapi.generators','scribe.groups.default','scribe.groups.order','scribe.logo',
...
'services.authentik.base_url','services.authentik.token','services.authentik.core_team_group_id','services.authentik.xcore_team_group_id','services.authentik.cg_admin_group_id',
'services.authentik.xcg_admin_group_id','view.paths','view.compiled','concurrency.default','session.driver',
...
'ignition.recorders','ignition.open_ai_key','ignition.with_stack_frame_arguments','ignition.argument_reducers','structure-discoverer.ignored_files',
...
'ARGON_THREADS','ARGON_TIME','AUTH_DUMMY_USER_ID','OIDC_CONFIGURATIONS_URI','OIDC_CLIENT_ID',
'OIDC_CLIENT_SECRET','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','BROADCAST_CONNECTION','QUEUE_CONNECTION','FILESYSTEM_DISK','CACHE_STORE',
'CACHE_PREFIX','REDIS_CLIENT','REDIS_HOST','REDIS_PORT','REDIS_PASSWORD',
'AUTHENTIK_BASE_URL','AUTHENTIK_TOKEN','AUTHENTIK_CORE_TEAM_GROUP_ID','AUTHENTIK_XCORE_TEAM_GROUP_ID','AUTHENTIK_CG_ADMIN_GROUP_ID',
'AUTHENTIK_XCG_ADMIN_GROUP_ID','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
