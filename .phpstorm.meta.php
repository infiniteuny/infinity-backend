...
'octane.swoole.options.package_max_length','octane.swoole.options.open_http2_protocol','octane.swoole.options.document_root','octane.swoole.options.enable_static_handler','oidc.issuer',
'oidc.configurations_uri','oidc.jwks_uri','oidc.authorization_endpoint','oidc.client_id','oidc.client_secret',
...
'services.authentik.base_url','services.authentik.client_id','services.authentik.client_secret','services.authentik.redirect','view.paths',
...
'ARGON_THREADS','ARGON_TIME','OIDC_ISSUER','OIDC_CONFIGURATIONS_URI','OIDC_JWKS_URI',
'OIDC_AUTHORIZATION_ENDPOINT','OIDC_CLIENT_ID','OIDC_CLIENT_SECRET','LOG_CHANNEL','LOG_STACK',
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','BROADCAST_CONNECTION','QUEUE_CONNECTION',
'FILESYSTEM_DISK','CACHE_STORE','CACHE_PREFIX','REDIS_CLIENT','REDIS_HOST',
'REDIS_PORT','REDIS_PASSWORD','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
