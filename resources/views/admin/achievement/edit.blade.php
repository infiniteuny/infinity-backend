                            ...
                            <div class="row g-3" style="margin-bottom: 1rem !important;">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_rank" name="competition_rank"
                                        required>
                                        <option value="{{ $data['achievement']->competition_rank_id }}" selected>
                                            {{ $data['achievement']->competition_rank }}
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_type" name="competition_type"
                                        required>
                                        <option value="{{ $data['achievement']->competition_type_id }}" selected>
                                            {{ $data['achievement']->competition_type }}
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_scale" name="competition_scale"
                                        required>
                                        <option value="{{ $data['achievement']->competition_scale_id }}" selected>
                                            {{ $data['achievement']->competition_scale }}
                                        </option>
                            ...
                            <div class="row g-3" style="margin-bottom: 1rem !important;">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_outputs"
                                        ...
                                        <option value="{{ $data['achievement']->competition_output_id }}" selected>
                                            {{ $data['achievement']->competition_output }}
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_time_range"
                                        ...
                                        <option value="{{ $data['achievement']->competition_time_range_id }}" selected>
                                            {{ $data['achievement']->competition_time_range }}
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select digits" id="competition_level" name="competition_level"
                                        required>
                                        <option value="{{ $data['achievement']->competition_level_id }}" selected>
                                            {{ $data['achievement']->competition_level }}
                                        </option>
