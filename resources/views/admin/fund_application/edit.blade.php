    ...
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-12">
                    <form class="card"
                        action="{{ route('admin.fund-application.update', Crypt::encryptString($data['fund']->id)) }}"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="status" class="form-select digits" required>
                                            <option value="waiting"
                                                {{ $data['fund']->status == 'waiting' ? 'selected' : '' }}>Pending</option>
                                            <option value="accepted"
                                                {{ $data['fund']->status == 'accepted' ? 'selected' : '' }}>Approved
                                            </option>
                                            <option value="rejected"
                                                {{ $data['fund']->status == 'rejected' ? 'selected' : '' }}>Rejected
                                            </option>
                                        </select>
                                    </div>
                                </div>
