...
@section('content')
    ...
    <div id="tm-area-heroslider" class="tm-heroslider">
        <div class="tm-heroslider-inner">
            <img src="{{ asset('landing/assets/images/heroslider-overlay-shape.png') }}" alt="heroslider ovelay"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-5 order-1 order-lg-2">
                        <div class="tm-heroslider-mobileshow">
                            <img src="{{ asset('landing/assets/images/inf.png') }}" alt="appmyil logo 3d">
    ...
    <main class="page-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="tm-about-image">
                            <img class="tm-about-mobilethumb" src="{{ asset('landing/assets/images/about-image.svg') }}"
                                alt="about mobile">
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="row mt-40-reverse">
                            ...
                            <div class="col-lg-12 col-md-6 col-12 mt-40">
                                <div class="tm-service">
                                    <span class="tm-service-icon">
                                        <img src="{{ asset('landing/assets/images/hustler.svg') }}" alt="hustler">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="70px" height="72px">
                            ...
                            <div class="col-lg-12 col-md-6 col-12 mt-40">
                                <div class="tm-service">
                                    <span class="tm-service-icon">
                                        <img src="{{ asset('landing/assets/images/hipster.svg') }}" alt="hipster">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="70px" height="72px">
                                            <path fill-rule="evenodd"
                                                d="M52.556,54.307 C64.348,37.302 73.747,12.982 68.512,4.877 C60.795,-7.064 13.848,4.659 2.850,20.520 C2.466,21.074 2.124,21.636 1.831,22.199 C-6.854,38.889 17.104,75.968 33.774,71.638 C39.513,70.148 46.364,63.237 52.556,54.307 " />
                            ...
                            <div class="col-lg-12 col-md-6 col-12 mt-40">
                                <div class="tm-service">
                                    <span class="tm-service-icon">
                                        <img src="{{ asset('landing/assets/images/hacker.svg') }}" alt="hacker">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="70px" height="72px">
                                            <path fill-rule="evenodd"
                                                d="M52.556,54.307 C64.348,37.302 73.747,12.982 68.512,4.877 C60.795,-7.064 13.848,4.659 2.850,20.520 C2.466,21.074 2.124,21.636 1.831,22.199 C-6.854,38.889 17.104,75.968 33.774,71.638 C39.513,70.148 46.364,63.237 52.556,54.307 " />
                    ...
                    <div class="col-lg-6">
                        <div class="tm-service-image">
                            <div class="tm-service-image-1 is-visible">
                                <img src="{{ asset('landing/assets/images/char-hustler.svg') }}" alt="hustler">
                            </div>
                            <div class="tm-service-image-2">
                                <img src="{{ asset('landing/assets/images/char-hipster.svg') }}" alt="hipster">
                            </div>
                            <div class="tm-service-image-3">
                                <img src="{{ asset('landing/assets/images/char-hacker.svg') }}" alt="hacker">
                            </div>
        ...
        <div id="tm-area-video" class="tm-video-funfact-area tm-section tm-padding-section bg-grey">
            <div class="tm-video-funfact-bgshape">
                <img src="{{ asset('landing/assets/images/funfact-bg-shape.png') }}" alt="bg shape">
            </div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="tm-videobox tm-videobox-circle tm-funfact-videobox">
                            <img src="{{ asset('landing/assets/images/video-thumb.svg') }}" alt="appmyil video image">
        ...
        <div id="tm-area-screenshots" class="tm-screenshot-area tm-section tm-padding-section bg-white">
            <div class="tm-screenshots-bgshape">
                <img src="{{ asset('landing/assets/images/screenshot-background-shape.png') }}"
        ...
        <div id="tm-area-testimonial" class="tm-testimonial-area tm-section tm-padding-section bg-white">
            <div class="tm-testimonial-bgshape">
                <img src="{{ asset('landing/assets/images/testimonial-bg-shape.png') }}" alt="appmyil bg shape">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="tm-faq-image">
                            <img src="{{ asset('landing/assets/images/faq-image.svg') }}" alt="faq image">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <!-- Accordion Wrapper -->
                            ...
                            <div class="tm-blog">
                                <div class="tm-blog-topside">
                                    <div class="tm-blog-image">
                                        <img src="{{ $event->media ?: asset('landing/assets/images/blog-image-1.jpg') }}"
        ...
        <div id="tm-area-contact" class="tm-contact-area tm-section tm-padding-section bg-white">
            <div class="tm-contact-bgshape">
                <img src="{{ asset('landing/assets/images/bg-shape-contact.png') }}" alt="contact shape">
            </div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="tm-sectiontitle text-center">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form id="tm-contactform" action="{{ route('contact-us') }}" method="post"
