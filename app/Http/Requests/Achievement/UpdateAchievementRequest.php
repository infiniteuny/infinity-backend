...
class UpdateAchievementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'competition_time_range_id' => ['sometimes', 'exists:competition_time_ranges,id'],
            'competition_output_id' => ['sometimes', 'exists:competition_outputs,id'],
            'competition_rank_id' => ['sometimes', 'exists:competition_ranks,id'],
